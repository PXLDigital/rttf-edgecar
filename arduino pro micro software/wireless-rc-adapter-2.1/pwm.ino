  ...
  #include "src/PinChangeInterrupt/PinChangeInterrupt.h"
    ...
    const uint8_t RC_PINS[6] = {10, 9, 6, 8, PB2, PB1};
...
//      rc_shared_values[id] = constrain(rc_shared_values[id], rc_min_values[id], rc_max_values[id]);
  ...
  void rcSetupPwm() {
    ...
    #if CHANNELS == 6
      Serial.println("setup channel 5");
    ...
    #endif
    Serial.println("finished setup of channels");
  }
